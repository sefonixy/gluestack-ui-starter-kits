...
> [!IMPORTANT]
> **Figma Theme & Color Mappings**: We have integrated a custom design token system mapping Figma colors, radii, and typography to gluestack-ui. For detailed instructions on updating colors, checking fallbacks, and using the playground, see the [Theme System Walkthrough](./THEME_WALKTHROUGH.md).
