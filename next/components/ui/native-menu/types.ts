/**
 * Shared types for the NativeMenu component.
 *
 * On native (iOS/Android) this renders via @react-native-menu/menu (UIMenu / PopupMenu).
 * On web this renders via gluestack-ui's popover Menu.
 */
