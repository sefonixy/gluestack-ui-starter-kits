...
const menuStyle = tva({
  base: 'rounded-md border border-outline-100 p-1 shadow-hard-5',
  variants: {
    variant: {
      default: 'bg-background-0',
      glass: 'bg-background-0 web:bg-white/70 web:backdrop-blur-md web:border-white/20 dark:web:bg-zinc-900/70 dark:web:border-zinc-800/50',
    },
  },
  defaultVariants: {
    variant: 'default',
...
const MenuSeparator = UIMenu.Separator ?? Separator;

Menu.displayName = 'Menu';
MenuItem.displayName = 'MenuItem';
MenuItemLabel.displayName = 'MenuItemLabel';
if (MenuSeparator) MenuSeparator.displayName = 'MenuSeparator';
