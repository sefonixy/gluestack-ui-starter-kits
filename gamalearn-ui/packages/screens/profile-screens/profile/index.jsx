...
const Sidebar = () => {
    ...
    return (<ScrollView className=" h-full" contentContainerStyle={{ flexGrow: 1 }}>
      <VStack className="h-full flex-1 w-[280px] py-4 pr-4 pl-8 items-center border-r border-border-300" space="xl">
          ...
          <Center className="absolute md:mt-14 mt-6 w-full md:px-10 md:pt-6 pb-4">
            <VStack space="lg" className="items-center">
              <Avatar size="2xl" className="bg-primary-600">
                <Image source={require("@/assets/profile-screens/profile/image.png")} height={"100%"} width={"100%"} alt="Avatar Image" contentFit="cover" style={{ borderRadius: "100%" }}/>
                <AvatarBadge />
              </Avatar>
            ...
            return (<HStack className="items-center gap-1" key={index}>
              ...
              <Button variant="outline" action="secondary" onPress={() => setShowModal(true)} className="gap-3 relative">
            ...
            <HStack className="py-5 px-6 border rounded-xl border-border-300 justify-between items-center" space="2xl">
              <HStack space="2xl" className="items-center">
                <Box className="md:h-20 md:w-20 h-10 w-10">
                  <Image source={require("@/assets/profile-screens/profile/image1.png")} height={"100%"} width={"100%"} alt="Promo Image"/>
                </Box>
                <VStack>
