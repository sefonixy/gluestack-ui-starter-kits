...
import defaultTokens from "./theme-tokens.json";
...
export function extendThemeConfig(customTokens: any) {
  const parsed = parseTheme(customTokens);
  return {
    light: vars({
      ...defaultLightVars,
      ...parsed.rawLight,
...
export const config = extendThemeConfig(defaultTokens);
